...
parser.add_argument('--dataset_type', type=str, default='ped2', choices=['ped2','avenue', 'shanghai', 'one_people', 'five_people', 'one_people_frist', 'five_people_frist'], help='type of dataset: ped2, avenue, shanghai')
...
python train.py --dataset_type one_people_frist --pseudo_anomaly_jump 0.01 --jump 2 3 4 5 \
 --model_dir /root/gan_anomaly/exp/one_people_frist/loglr0.0008weight_recon_pajump0.01_jump[2,3,4,5]/model_59.pth \
 --start_epoch 60
CUDA_VISIBLE_DEVICES=5,6 python train.py --dataset_type five_people_frist
CUDA_VISIBLE_DEVICES=6,7 python train.py --dataset_type five_people_frist --pseudo_anomaly_jump 0.01 --jump 2 3 4 5 --lr 0.008
'''